...
<ReactPlayer alt="Video of an app with a green background that shows searching for a pokemon and the image of said pokemon changing" width='375px' loop={true} playing={false} controls={true} url='/pokemon-styled-vid.mp4' />



## But wait, I actually don't want to style my components like that 
...
<ReactPlayer alt="Wrestling chair slam with the one getting hit subtitled 'boring old css' and the one hitting subtitled 'tailwind'"  width='375px' playing={true} controls={true} loop={true} url='/tailwind-wwe.mp4' />
